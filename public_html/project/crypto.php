...
$current_path = ($_SERVER["REQUEST_URI"]??$_SERVER["PHP_SELF"]) . (count($_GET)>0? "?" . http_build_query($_GET):"");
error_log("Stored url " . $current_path);
...
LEFT JOIN `IT202-S25-UserCrypto` uc on uc.crypto_id = c.id
