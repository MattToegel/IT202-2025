        ...
        <?php if (has_role("Admin")) : ?>
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <li><a href="<?php get_url('admin/list_stocks.php', true); ?>">List Stock</a></li>
                </div>
            </div>
        <?php endif; ?>
        <?php if (has_role("Admin")) : ?>
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <li><a href="<?php get_url('admin/create_company.php', true); ?>">Create Company</a></li>
                    <li><a href="<?php get_url('admin/list_companies.php', true); ?>">List Companies</a></li>
                </div>
            </div>
        <?php endif; ?>
        <?php if (is_logged_in()) : ?>
